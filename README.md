...
![Profile](assets/profile_new_4.png)
...
- 💼 LinkedIn: linkedin.com/in/arvind-koli
- 🐙 GitHub: github.com/arvind-koli
- 📱 Twitter: @arvind_koli
...
1. **Kotlin Basics** - Variables, Types, Operators
2. **Functions & Collections** - Lambda, List, Map
3. **OOP Concepts** - Classes, Inheritance, Interfaces
4. **Advanced Features** - Coroutines, Sealed Classes
5. **Android Integration** - MVVM, Room, Retrofit
